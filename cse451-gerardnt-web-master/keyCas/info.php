...
/*
 *
 * told not to worry about this one 
 *
...
function getRestValues($key){
	...
	try {
		$url = 'http://campbest.451.csi.miamioh.edu/cse451-campbest-web-public-2020/week2/week2-rest.php/apii/v1/info';
